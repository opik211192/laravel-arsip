    ...
    <div class="card-body">
        <form action="{{ route('arsip.edit', $arsip) }}" method="post" enctype="multipart/form-data">
            ...
            {{-- <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="judul_arsip" name="judul_arsip"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="pencipta_arsip" id="pencipta_arsip"
                        value="{{ old('pencipta_arsip') ?? $arsip->pencipta_arsip }}" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <select name="user_id" id="user_id" class="form-control" required>
                        ...
                        <option {{ $arsip->user_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{
                            $item->name." || {$item->unit->name}" }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <form action="{{ route('arsip.edit', $arsip) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="judul_arsip" id="judul_arsip"
                                value="{{ old('judul_arsip') ?? $arsip->judul_arsip }}" required>
                        </div>
                        @error('judul_arsip')
                        <div class="text-danger mt-2 d-block">{{ $message }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="lokasi_arsip" id="lokasi_arsip"
                                value="{{ old('lokasi_arsip') ?? $arsip->lokasi_arsip }}" required>
                        </div>
                        @error('lokasi_arsip')
                        <div class="text-danger mt-2 d-block">{{ $message }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_arsip" id="jenis_arsip" class="form-control" required>
                                ...
                                <option value="ku" {{ old('jenis_arsip') ?? $arsip->jenis_arsip == 'ku' ? 'selected' :
                                    '' }}>KU</option>
                                <option value="hk" {{ old('jenis_arsip') ?? $arsip->jenis_arsip == 'hk' ? 'selected' :
                                    '' }}>HK</option>
                                <option value="pl" {{ old('jenis_arsip') ?? $arsip->jenis_arsip == 'pl' ? 'selected' :
                                    '' }}>PL</option>
                                <option value="um" {{ old('jenis_arsip') ?? $arsip->jenis_arsip == 'um' ? 'selected' :
                                    '' }}>UM</option>
                                <option value="pr" {{ old('jenis_arsip') ?? $arsip->jenis_arsip == 'pr' ? 'selected' :
                                    '' }}>PR</option>
                                <option value="tn" {{ old('jenis_arsip') ?? $arsip->jenis_arsip == 'tn' ? 'selected' :
                                    '' }}>TN</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="tahun" id="tahun" class="form-control" required>
                                <option value="" selected disabled>Pilih Tahun</option>
                                @for ($i = 1987; $i <= date('Y'); $i++) <option {{ $arsip->tahun == $i ? 'selected' : ''
                                    }} value="{{ $i }}">{{ $i }}</option>
                                    @endfor
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pencipta_arsip" id="pencipta_arsip"
                                value="{{ $arsip->pencipta_arsip }}" required>
                        </div>
                        @error('pencipta_arsip')
                        <div class="text-danger mt-2 d-block">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="uraian_arsip" id="uraian_arsip" cols="30"
                                rows="5">{{ $arsip->uraian_arsip }}</textarea>
                        </div>
                        @error('uraian')
                        <div class="text-danger mt-2 d-block">{{ $message }}</div>
                        @enderror --}}
