        ...
        <table class="table table-striped table-sm" id="table-datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <a href="{{ route('arsip.edit', $a) }}" class="btn btn-success btn-sm" data-toggle="edit"
                                data-placement="top" title="Edit"><i class="fa-solid fa-user-pen"></i></a>&nbsp;
                            <a href="#" class="btn btn-warning btn-sm" data-toggle="detail" data-placement="top"
                                title="Detail"><i class="fa-solid fa-book"></i></a>&nbsp;
