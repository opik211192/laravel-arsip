               ...
               <table class="table table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>{{ $data->file_arsip }} <a href="{{ route('arsip.download', $data) }}" class="btn btn-sm btn-success ml-2" xdata-toggle="tooltip" data-placement="top" title="Download"><i class="fa fa-download" aria-hidden="true" ></i></a></td>
                        </tr>
                        <tr>
                            <td id="t">Unit</td>
                            <td>:</td>
